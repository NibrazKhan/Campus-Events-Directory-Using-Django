...
# Why adding them here? - Django only checks the root URLConf, 404/500 errors can happen anywhere, not just in one app, Error handlers are part of the global request/response pipeline
